...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    date: "February 2025",
    text: "Rented an SUV for a family road trip from Rabat to Marrakech. The car was clean, well-maintained, and exactly what was advertised. The team was super helpful throughout. Will definitely use again!",
    vehicle: "Honda CR-V",
  ...
  },
  {
    ...
    rating: 5,
    date: "March 2025",
    text: "Rented the Honda CBR for a weekend trip through the Atlas roads. Bike was in great condition, and the rental price was fair. The pickup was easy and staff were professional. 10/10 overall.",
  ...
  },
  {
    ...
    rating: 5,
    date: "March 2025",
    text: "Rented a Yamaha NMAX to explore Agadir's coastline and it was the best decision. The scooter was brand new, fuel-efficient, and the rental was super affordable. Engenz made my trip unforgettable.",
    vehicle: "Yamaha NMAX",
